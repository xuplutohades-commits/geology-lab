...
const QUES = [
  {
    ...
    conclusion: "山岭也可能由向斜形成：向斜核部受挤压、岩层坚硬，被侵蚀后反而残留为山（向斜山）。所以“山岭 = 背斜”是常见误区。",
  },
  {
    q: "看到谷地，它就一定是向斜吗？",
    opts: ["一定是", "不一定"],
    ...
    conclusion: "背斜顶部受张力破碎、易被侵蚀，长期剥蚀后可形成谷地（背斜谷）。判读构造必须看岩层新老与弯曲方向，不能只看地形。",
  },
  {
    q: "背斜永远会形成山吗？",
    opts: ["永远会", "不一定"],
    correct: 1,
    demo: (active: boolean) => <MiniErosion kind="anticline-valley" active={active} />,
    conclusion: "不一定。背斜山只是“初期形态”；在足够长的侵蚀时间后，背斜会反转成背斜谷——构造与地貌不是一一对应。",
  },
  {
    q: "向斜永远会形成谷吗？",
    opts: ["永远会", "不一定"],
    correct: 1,
    demo: (active: boolean) => <MiniErosion kind="syncline-mountain" active={active} />,
    conclusion: "不一定。向斜核部岩层坚硬、不易侵蚀，长期外力作用下可能残留为向斜山。",
  },
  {
    q: "所有断层在地表都能直接看见吗？",
    opts: ["都能看见", "不一定都能看见"],
    ...
    conclusion: "不一定。许多断层被第四纪沉积物、植被或水体覆盖，成为“潜伏断层”；只有出露地表或错断地貌的断层才可能直接看到。",
  },
];
